...
function CandidateDetails() {
  ...
  const selectedCourseRaw = localStorage.getItem("selected_course");
  const selectedCourse = selectedCourseRaw
  ...
  const [formData, setFormData] = useState({
    ...
    rank: existing.rank || "",
    cdcNumber: existing.cdcNumber || "",
    courseName: selectedCourse.name || "Personal Safety",
  });
    ...
    <div className="min-h-screen bg-gray-100 p-10">
      <div className="max-w-3xl mx-auto bg-white rounded-xl shadow p-8">
        ...
        <p className="mb-6 text-gray-700">
          Selected CBT:{" "}
          <strong>{selectedCourse.name || "Personal Safety"}</strong>
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <input
              type="text"
              value={selectedCourse.name || "Personal Safety"}
              readOnly
