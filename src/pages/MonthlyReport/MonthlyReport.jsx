    ...
    <div className="min-h-screen bg-gray-100 p-8">
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-4xl font-bold">Monthly Report</h1>
            <p className="text-gray-600 mt-2">
              Generate encrypted month-wise CBT completion archive for office
              submission.
            </p>
          </div>
        ...
        >
          ...
          <button
            disabled={loading}
            className="px-6 py-3 rounded bg-blue-600 text-white disabled:opacity-60"
          >
          ...
          <p className="text-sm text-gray-600 mt-4">
            ...
            application user data folder. The checksum is used for tamper
            detection.
          </p>
        </form>
